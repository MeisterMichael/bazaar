...
RSpec.describe SwellEcom::CheckoutController, :type => :controller do
	...
	let(:new_trial_subscription_plan) {
		SwellEcom::SubscriptionPlan.create( slug: "subscription-plan-1-#{(0...20).map { (65 + rand(26)).chr }.join}", title: "Qualia Subscription w/ Trial", trial_price: 99, trial_max_intervals: 1, price: 12900, billing_interval_unit: 'weeks', billing_interval_value: 4, trial_interval_unit: 'days', trial_interval_value: 7 )
	}
	let(:new_trial_subscription_plan2) {
		SwellEcom::SubscriptionPlan.create( slug: "subscription-plan-2-#{(0...20).map { (65 + rand(26)).chr }.join}", title: "Qualia Subscription w/ Trial 199", trial_price: 199, trial_max_intervals: 1, price: 14900, billing_interval_unit: 'weeks', billing_interval_value: 2, trial_interval_unit: 'days', trial_interval_value: 3 )
	}
