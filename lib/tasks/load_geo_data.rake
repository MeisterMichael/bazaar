namespace :swell_ecom do
	task :load_geo_data do
		...
		usa.geo_states.create :country => 'US', :name => 'Massachusetts', :abbrev => 'MA'
		...
		r = TaxRate.create :geo_state_id => 5 , :rate => 0.0725
		...
		r = TaxRate.create :geo_state_id => 52 , :rate => 0
		r = TaxRate.create :geo_state_id => 53 , :rate => 0
		r = TaxRate.create :geo_state_id => 54 , :rate => 0
	end
end