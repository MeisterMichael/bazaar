...
module SwellEcom
	class CheckoutController < ApplicationController
		...
		def create
			...
			@order.user ||= User.all.create_with( first_name: @order.billing_address.first_name, last_name: @order.billing_address.last_name ).find_or_create_by( email: @order.email ) if @order.email.present? && SwellEcom.create_user_on_checkout
