module BazaarAdmin
	class OrderItemAdminController < BazaarAdmin::EcomAdminController
		...
		def create
			...
			@order_item = BazaarCore::OrderItem.new( order_item_params )
		...
		def destroy
			...
			@order_item = BazaarCore::OrderItem.find( params[:id] )
			authorize( @order_item.order )
