module BazaarAdmin
	class ShipmentAdminController < BazaarAdmin::EcomAdminController
		...
		def edit
			...
			if @shipment.draft?
				render( 'bazaar_admin/shipment_admin/edit_draft' )
			else
				render( 'bazaar_admin/shipment_admin/edit' )
			end
		end
		...
		def index
			...
			render( 'bazaar_admin/shipment_admin/index' )
		end
		...
		def new
			...
			render( 'bazaar_admin/shipment_admin/new' )
		end
