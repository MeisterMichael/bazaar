module Bazaar
	class UpsellOfferAdminController < Bazaar::EcomAdminController
		...
		def upsell_offer_params
			params.require(:upsell_offer).permit( :src_offer_id, :src_product_id, :offer_id, :full_price_offer_id, :upsell_type, :status, :title, :description, :supplemental_disclaimer, :savings, :full_price, :image_url, :upsell_id )
		end
