	...
	module TransactionServices
		...
		class AuthorizeDotNetTransactionService < SwellEcom::TransactionService
			...
			def process( order, args = {} )
				...
				elsif ( first_profile_transaction = SwellEcom::Transaction.where( provider: @provider_name, customer_profile_reference: profiles[:customer_profile_reference], customer_payment_profile_reference: profiles[:customer_payment_profile_reference] ).where("properties::hstore ? 'credit_card_ending_in'").first ).present?
